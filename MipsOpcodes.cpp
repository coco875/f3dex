...
//		*1 = SPECIAL	*2 = REGIMM		*3 = COP0		*4 = COP1		*5 = COP2
	...
	{ "cop2",	"i25",				MIPS_OP(0x12)|(1<<25), 	MA_PSX|MA_MIPS1,		0 },
	...
	{ "lwc2",	"gt,i16(s)",		MIPS_OP(0x32),			MA_PSX|MA_MIPS1,		0 },
	{ "lwc2",	"gt,(s)",			MIPS_OP(0x32),			MA_PSX|MA_MIPS1,		0 },
	...
	{ "swc2",	"gt,i16(s)",		MIPS_OP(0x3A),			MA_PSX|MA_MIPS1,		0 },
	{ "swc2",	"gt,(s)",			MIPS_OP(0x3A),			MA_PSX|MA_MIPS1,		0 },
